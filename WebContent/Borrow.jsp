...
<%
	...
	try{
		...
		String  sql_book = "select *from BookI";
		Statement st_book=conn.createStatement();
        ResultSet rs_book=st_book.executeQuery(sql_book);
		String  sql = "select a.tno,a.bname,a.pubdept,a.typnum,a.price,b.bno,b.bstate from BookI a,BorrowI b  where a.tno = b.tno order by b.bno";
